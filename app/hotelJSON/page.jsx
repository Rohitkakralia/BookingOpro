...
function BookingFlowContent() {
  ...
  const hotelData = bookingId
    ? JSON.parse(sessionStorage.getItem(`${bookingId}_hotel`) || "null")
    : null;
  const roomData = bookingId
    ? JSON.parse(sessionStorage.getItem(`${bookingId}_room`) || "null")
    : null;
    ...
    return (
      ...
      >
        ...
        >
          ...
          <p
            style={{ color: "#6b7a8d", fontSize: "16px", marginBottom: "8px" }}
          >
  ...
  const freeCancelBefore = paymentType?.cancellation_penalties?.free_cancellation_before;
  const vatTax = paymentType?.tax_data?.taxes?.find((t) => t.name === "vat");
  const cityTax = paymentType?.tax_data?.taxes?.find((t) => t.name === "city_tax");
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "36px 20px" }}>
        ...
        <div style={{ marginBottom: "28px" }}>
          ...
          <p style={{ color: "#6b7a8d", fontSize: "15px", margin: 0 }}>
            Review your selection and fill in your details to confirm the reservation.
          </p>
        </div>
        ...
        >
          ...
          <div style={{ position: "sticky", top: "80px" }}>
            ...
            <div style={{ ...sectionCard, marginBottom: "16px" }}>
              ...
              >
                {[
                  { label: "Check-in", value: "Mar 14, 2026" },
                  { label: "Check-out", value: "Mar 17, 2026" },
                ].map(({ label, value }) => (
                  <div
                    key={label}
                    style={{
              ...
              >
                ...
                {beddingType && (
                  <p
                    style={{ fontSize: "13px", color: "#6b7a8d", margin: "0 0 8px" }}
                  >
                    🛏️ {beddingType}
                  </p>
                )}
              ...
              >
                {freeCancelBefore
                  ? `✅ Free cancellation before ${new Date(freeCancelBefore).toLocaleDateString("en-GB", { day: "numeric", month: "short", year: "numeric" })}`
